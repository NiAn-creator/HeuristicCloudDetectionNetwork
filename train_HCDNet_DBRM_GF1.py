...
from datasets import wscd_train,wscd_trainval,wscd_test
...
def get_argparser():
    ...
    parser.add_argument("--model", type=str, default='mResNet34_RAPL_DBRM',
                        choices=[ 'mResNet34_RAPL_DBRM','mResNet34_RAPL_BRM',
                                  'mResNet50_RAPL_DBRM','mResNet50_RAPL_BRM',
                                  'VGG16_RAPL_DBRM','VGG16_RAPL_BRM'], help='model name')
